...
bayes <- subset(x, method_id == "BayesSpace" & grepl("^rigor-backfill", notes) & dataset_id %in% c("GSE267401", "GSE311294", "GSE285505"))
...
base <- subset(
  ...
  method_id %in% c("M0_expr_kmeans", "M1_spatial_concat_kmeans", "M2_spatial_ward", "M3_spatial_leiden", "M4_spagcn", "M5_stagate") &
    ...
    dataset_id %in% c("GSE267401", "GSE311294", "GSE285505")
)
